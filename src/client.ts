...
export class Caret {
  ...
  get(path: string, options?: { params?: Record<string, any>; headers?: Record<string, string> }) {
    return this.request('GET', path, options);
  }

  post(path: string, options?: { body?: any; headers?: Record<string, string> }) {
    return this.request('POST', path, options);
  }

  patch(path: string, options?: { body?: any; headers?: Record<string, string> }) {
    return this.request('PATCH', path, options);
  }

  put(path: string, options?: { body?: any; headers?: Record<string, string> }) {
